...
public class DingdanxinxiController {
    ...
    public R page(@RequestParam Map<String, Object> params,DingdanxinxiEntity dingdanxinxi, 
		...
		if(tableName.equals("laorenzhanghao")) {
			dingdanxinxi.setLaorenzhanghao((String)request.getSession().getAttribute("username"));
		}
		if(tableName.equals("gongzuorenyuan")) {
			dingdanxinxi.setRenyuanzhanghao((String)request.getSession().getAttribute("username"));
		}
